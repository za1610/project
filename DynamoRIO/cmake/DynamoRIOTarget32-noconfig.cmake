...
SET_TARGET_PROPERTIES(dynamorio PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib32/release/libdynamorio.so.3.2"
...
SET_TARGET_PROPERTIES(drdecode PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib32/release/libdrdecode.a"
  )
...
SET_TARGET_PROPERTIES(drsyms PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/ext/lib32/release/libdrsyms.so"
...
SET_TARGET_PROPERTIES(drmgr PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_NOCONFIG "dynamorio"
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/ext/lib32/release/libdrmgr.so"
...
SET_TARGET_PROPERTIES(drwrap PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/ext/lib32/release/libdrwrap.so"
...
SET_TARGET_PROPERTIES(drutil PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/ext/lib32/release/libdrutil.so"
